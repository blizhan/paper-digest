...
| [TabPFN-3.5: Technical Report](./knowledge/papers/tabpfn-3-5-technical-report.md) | tabular foundation model, ICL, Fourier/ECDF, probabilistic regression, temporal generalization | [arXiv](https://arxiv.org/abs/2609.17895v1) · [GitHub](https://github.com/PriorLabs/TabPFN) · [Weights](https://huggingface.co/Prior-Labs/tabpfn_3_5) | 已讨论 / 已读源码 | 以 Fourier/ECDF、联合分类回归和更强 prior 扩展表格 ICL；ScoringBench 强但不能单独归因于 ECDF，公开架构也没有原生时间顺序或 Query 间状态传递。 |
